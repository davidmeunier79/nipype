...
def modify_prethresh_fsf(fsf_file,prethresh_mask_file):
    ...
    with open(fsf_file) as f:
        ...
        for line in lines:
            ...
            if len(splitted_line) != 0:
                ...
                if splitted_line[0] == "set" and splitted_line[1] == "fmri(analysis)" :
                    
                    line = splitted_line[0] + " " + splitted_line[1] + " 7\n"
                    
                
                if splitted_line[0] == "set" and splitted_line[1] == "fmri(filtering_yn)" :
                    
                    line = splitted_line[0] + " " + splitted_line[1] + " 1\n"
    ...
    with open(modified_fsf_file,"w+") as f:
        
        f.writelines(new_lines)
        
    return modified_fsf_file



def create_modelfit_workflow_prethresh(name='modelfit', f_contrasts=False):
    ...
    modifyfsf=pe.Node(interface=util.Function(input_names=['fsf_file','prethresh_mask_file'],output_names=['modified_fsf_file'],function=modify_prethresh_fsf), name="modifyfsf")
    ...
    modelfit.connect([
        ...
        (level1design, modifyfsf, [('fsf_files', 'fsf_file')]),
        
        (modifyfsf,modelgen, [('modified_fsf_file', 'fsf_file')]),
